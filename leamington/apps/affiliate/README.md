...
client (4 fields), the issued code, my clients, my earnings. Plus sign-in and
the one-time password setup link.
...
| `/earnings` | `affiliate_earnings`, commissions, payouts |
